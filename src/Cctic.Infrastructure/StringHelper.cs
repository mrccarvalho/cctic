...
namespace Cctic.Infrastructure
{
    public static class StringHelper
    {
        ...
        private static string ConvCcticdgeCases(string text)
        {
            var sb = new StringBuilder();
            foreach (var c in text)
            {
                sb.Append(ConvCcticdgeCases(c));
            }

            return sb.ToString();
        }

        private static string ConvCcticdgeCases(char c)
        {
            string swap;
            switch (c)
            {
