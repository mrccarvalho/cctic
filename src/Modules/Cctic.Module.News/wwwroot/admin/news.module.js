...
(function () {
    ...
    angular.module('CcticAdmin.news', [])
        .config(['$stateProvider', function ($stateProvider) {
            $stateProvider
                ...
                .state('widget-news-create', {
                    url: '/widget-news/create',
                    templateUrl: 'modules/news/admin/news-widget/news-widget-form.html',
                    controller: 'NewsWidgetFormCtrl as vm'
                })
                .state('widget-news-edit', {
                    url: '/widget-news/edit/:id',
                    templateUrl: 'modules/news/admin/news-widget/news-widget-form.html',
                    controller: 'NewsWidgetFormCtrl as vm'
                });
